...
* **SSc**: The name of the source as indicated by a digit string (see source code  * * * *  * classification table)
...
**note**: summary and col info is not shown as it takes longer to load
